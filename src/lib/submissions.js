...
// ── SETTINGS ────────────────────────────────────────────────────────────────
// Settings are stored as rows: { key: 'customers', value: ['Diamondback', ...] }
// Table: app_settings (key text primary key, value jsonb, updated_at timestamptz)
...
export async function saveSubmission(formData, userId) {
  ...
  const payload = {
    ...
    data: {
      ...
      laborHours, hourlyRate, billableTechs: effectiveBillable,
      description, glCode, assetTag, workArea, startTime, departureTime,
